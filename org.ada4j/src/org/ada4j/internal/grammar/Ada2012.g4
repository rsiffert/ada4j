...
:
    ...
    | conditional_expression // parentheses may be omitted if the context already contains parentheses (expression function i.e.) - TODO find a way to make this contextual
    | LPAR quantified_expression RPAR
    | quantified_expression // parentheses may be omitted if the context already contains parentheses (expression function i.e.) - TODO find a way to make this contextual
    | aggregate;
