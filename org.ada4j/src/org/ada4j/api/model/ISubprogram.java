...
/**
 * This class corresponds to an Ada subprogram which can either be a procedure or a function.
 * @author RS
 *
 */
public interface ISubprogram extends INamedUnit {
	 ...
	 * @return an int worth either ISubprogram.FUNCTION or ISubprogram.PROCEDURE.
	 */
	public int getType();
	 ...
	 * @return a list containing the arguments of the subprogram, empty if subprogram takes no argument.
	 */
